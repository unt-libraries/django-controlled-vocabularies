...
class VocabularyHandler:
    ...
    def create_xml(c):
        ...
        vocab_namespace = settings.VOCAB_DOMAIN+'vocabularies/'+c.vocab.name+'/'
        purl_namespace = 'http://purl.org/NET/UNTL/vocabularies/formats/'
        #Define Static Attributes
        root_attribs = {'xmlns:dcq':'http://purl.org/dc/terms/'}
        description_attribs = {'rdf:about':vocab_namespace}
